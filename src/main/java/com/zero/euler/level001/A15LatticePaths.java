...
public class A15LatticePaths {
    ...
    public static BigInteger computeCombination(int gridLength) {
        ...
        BigInteger nFactorial = A20FactorialDigitSum.computeFactorial(pathLength);
        BigInteger kFactorial = A20FactorialDigitSum.computeFactorial(gridLength);
    ...
    public static BigInteger optimizedCombination(int n) {
        ...
        BigInteger denominator = A20FactorialDigitSum.computeFactorial(n);
